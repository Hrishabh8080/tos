...
export default function ProductDetailPage() {
    ...
    try {
      ...
      if (!forceRefresh) {
        try {
          ...
          console.warn('Error reading cache, fetching fresh data:', cacheError);
      ...
      if (response.ok) {
        ...
        if (contentType?.includes('application/json')) {
          ...
          try {
            ...
            console.warn('Failed to cache related products:', cacheError);
          }
        }
      }
    } catch (error) {
  ...
  const handleContactRequest = useCallback(async () => {
    if (!product || !mobileNumber || !mobileNumber.trim()) {
